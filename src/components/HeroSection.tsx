...
export const HeroSection = () => {
  return (
    <section className="relative">
      ...
      <div className="relative z-10 mx-auto flex max-w-container-max-width flex-col items-center gap-12 px-gutter py-section-padding-mobile md:flex-row md:py-section-padding-desktop">
        <div className="flex-1 text-center md:text-left">
          ...
          <p className="mt-6 font-caption text-caption text-on-surface-variant">
            Grátis para sempre · Funciona no navegador do celular e do computador · Sem instalar nada
          </p>
        </div>
